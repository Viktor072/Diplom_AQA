...
* Нажать Продолжить.
* Ожидаемый результат: появится всплывающее окно "Ошибка! Банк отказал в проведении операции!", должна прийти ошибка 500 с бэкенда по запросу http://localhost:8080/api/v1/credit.
...
* Удостоверяемся, что при обращении к URL-адресу http://localhost:8080/api/v1/pay мы получаем код ответа сервера 200 и банковская карта c номером 4444 4444 4444 4441 отдает статус APPROVED.
* Удостоверяемся, что при обращении к URL-адресу http://localhost:8080/api/v1/pay мы получаем код ответа сервера 200 и банковская карта с номером 4444 4444 4444 4442 отдает статус DECLINED.
* Удостоверяемся, что при обращении к URL-адресу http://localhost:8080/api/v1/credit мы получаем код ответа сервера 200 и банковская карта c номером 4444 4444 4444 4441 отдает статус APPROVED.
* Удостоверяемся, что при обращении к URL-адресу http://localhost:8080/api/v1/credit мы получаем код ответа сервера 200 и банковская карта с номером 4444 4444 4444 4442 отдает статус DECLINED.
